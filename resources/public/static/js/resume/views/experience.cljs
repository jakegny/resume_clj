...
(defn component []
  [:div
   ...
   [:div
    [:div {:class "company"}
     [:img {:class "company-logo cambia" :src "static/images/cambiahealth.jpg" :alt "cambia health solutions logo"}]
   ...
   [:div
    [:div {:class "company"}
     [:img {:class "company-logo square" :src "static/images/skillsai.png" :alt "skillsai logo"}]
   ...
   [:div
    [:div {:class "company"}
     [:img {:class "company-logo nike" :src "static/images/nike.png" :alt "nike logo"}]
   ...
   [:div
    [:div {:class "company"}
     [:img {:class "company-logo square" :src "static/images/skyward.png" :alt "skyward logo"}]
   ...
   [:div
    [:div {:class "company"}
     [:img {:class "company-logo intel" :src "static/images/intelLogo.png" :alt "intel logo"}]
   ...
   [:div
    [:div {:class "company"}
     [:img {:class "company-logo columbia" :src "static/images/columbiasteel.png" :alt "columbia steel logo"}]
   ...
   [:div
    [:div {:class "company"}
     [:img {:class "company-logo up" :src "static/images/up.png" :alt "university of portland logo"}]
