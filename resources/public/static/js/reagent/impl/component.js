...
if((i < len)){
var k = (ks[i]);
var G__5864 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__5865 = (i + (1));
m = G__5864;
i = G__5865;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5866 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__5866) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__5866));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__5868 = c;
var G__5868__$1 = (((G__5868 == null))?null:G__5868.prototype);
if((G__5868__$1 == null)){
return null;
} else {
return (G__5868__$1["reagentRender"]);
}
})() == null))));
});
...
var G__5872 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5872) : reagent.impl.component.as_element.call(null,G__5872));
};
...
while (G__5875__i < G__5875__a.length) {G__5875__a[G__5875__i] = arguments[G__5875__i + 0]; ++G__5875__i;}
  args = new cljs.core.IndexedSeq(G__5875__a,0,null);
} 
...
var _STAR_current_component_STAR_5878 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_5878;
}});
...
return ((function (G__5879,G__5879__$1){
...
var c = this;
var G__5884_5886 = (c["cljsRatom"]);
if((G__5884_5886 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5884_5886);
}
...
var renders_5888 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_5889 = cljs.core.first(cljs.core.vals(renders_5888));
if((cljs.core.count(renders_5888) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5888))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5889)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5889], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5887 = name;
switch (G__5887) {
case "":
...
var G__5892 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__5892) : reagent.impl.component.global$module$create_react_class.call(null,G__5892));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__5893 = fiber;
var G__5893__$1 = (((G__5893 == null))?null:(G__5893["type"]));
if((G__5893__$1 == null)){
return null;
} else {
return (G__5893__$1["displayName"]);
}
})();
var parent = (function (){var G__5894 = fiber;
if((G__5894 == null)){
return null;
} else {
return (G__5894["return"]);
}
})();
var path = (function (){var G__5895 = parent;
var G__5895__$1 = (((G__5895 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5895) : reagent.impl.component.fiber_component_path.call(null,G__5895)));
if((G__5895__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5895__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__5897 = c;
if((G__5897 == null)){
return null;
} else {
return (G__5897["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__5898._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__5900 = c;
if((G__5900 == null)){
return null;
} else {
return (G__5900["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__5902 = c;
if((G__5902 == null)){
return null;
} else {
...
var elem = (function (){var or__3922__auto__ = (function (){var G__5904 = instance;
if((G__5904 == null)){
return null;
} else {
return (G__5904["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__5905 = instance;
if((G__5905 == null)){
return null;
} else {
return G__5905._currentElement;
}
}
})();
var name = (function (){var G__5906 = elem;
var G__5906__$1 = (((G__5906 == null))?null:(G__5906["type"]));
if((G__5906__$1 == null)){
return null;
} else {
return (G__5906__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__5908 = elem;
if((G__5908 == null)){
return null;
} else {
return (G__5908["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__5909._owner;
}
}
})();
var path = (function (){var G__5910 = owner;
var G__5910__$1 = (((G__5910 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5910) : reagent.impl.component.component_path.call(null,G__5910)));
if((G__5910__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5910__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__5911 = c;
var G__5911__$1 = (((G__5911 == null))?null:G__5911.constructor);
if((G__5911__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5911__$1);
}
}
})();
