...
if((i < len)){
var k = (ks[i]);
var G__5866 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__5867 = (i + (1));
m = G__5866;
i = G__5867;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5868 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__5868) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__5868));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__5870 = c;
var G__5870__$1 = (((G__5870 == null))?null:G__5870.prototype);
if((G__5870__$1 == null)){
return null;
} else {
return (G__5870__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__5872 = c;
var G__5872__$1 = (((G__5872 == null))?null:G__5872.prototype);
if((G__5872__$1 == null)){
return null;
} else {
return (G__5872__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__5876__delegate = function (args){
var G__5874 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5874) : reagent.impl.component.as_element.call(null,G__5874));
};
...
var _STAR_current_component_STAR_5880 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_5880;
}});
...
return ((function (G__5881,G__5881__$1){
...
var c = this;
var G__5886_5888 = (c["cljsRatom"]);
if((G__5886_5888 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5886_5888);
}
...
var renders_5890 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_5891 = cljs.core.first(cljs.core.vals(renders_5890));
if((cljs.core.count(renders_5890) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5890))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5891)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5891], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5889 = name;
switch (G__5889) {
case "":
...
var G__5894 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__5894) : reagent.impl.component.global$module$create_react_class.call(null,G__5894));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__5895 = fiber;
var G__5895__$1 = (((G__5895 == null))?null:(G__5895["type"]));
if((G__5895__$1 == null)){
return null;
} else {
return (G__5895__$1["displayName"]);
}
})();
var parent = (function (){var G__5896 = fiber;
if((G__5896 == null)){
return null;
} else {
return (G__5896["return"]);
}
})();
var path = (function (){var G__5897 = parent;
var G__5897__$1 = (((G__5897 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5897) : reagent.impl.component.fiber_component_path.call(null,G__5897)));
if((G__5897__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5897__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__5899 = c;
if((G__5899 == null)){
return null;
} else {
return (G__5899["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__5900._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__5902 = c;
if((G__5902 == null)){
return null;
} else {
return (G__5902["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__5904 = c;
if((G__5904 == null)){
return null;
} else {
return G__5904._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__5906 = instance;
if((G__5906 == null)){
return null;
} else {
return (G__5906["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__5907 = instance;
if((G__5907 == null)){
return null;
} else {
return G__5907._currentElement;
}
}
})();
var name = (function (){var G__5908 = elem;
var G__5908__$1 = (((G__5908 == null))?null:(G__5908["type"]));
if((G__5908__$1 == null)){
return null;
} else {
return (G__5908__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__5910 = elem;
if((G__5910 == null)){
return null;
} else {
return (G__5910["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__5911._owner;
}
}
})();
var path = (function (){var G__5912 = owner;
var G__5912__$1 = (((G__5912 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5912) : reagent.impl.component.component_path.call(null,G__5912)));
if((G__5912__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5912__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__5913 = c;
var G__5913__$1 = (((G__5913 == null))?null:G__5913.constructor);
if((G__5913__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5913__$1);
}
}
})();
